...
def consolidate_ecotaxa_project(project_id,standardizer=df_standardizer_ecotaxa,sheetname='ecotaxa',run_macro=False,upload_metadata=False,localpath_metadata=Path(cfg['raw_dir']).expanduser()/cfg['UVP_consolidation_subdir']):
   """
